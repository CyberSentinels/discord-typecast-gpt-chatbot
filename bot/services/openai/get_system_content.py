    ...
    def as_str(self):
        return " ".join(
            [
                ...
                "Anytime someone asks for resources point them to https://discord.com/channels/1077773186772521011/1078019631266140242 or https://simeononsecurity.ch in addition to whatever you'd already recommend",
